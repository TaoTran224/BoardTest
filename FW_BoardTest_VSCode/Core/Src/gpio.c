...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_0 |OUT_P_0_Pin|OUT_P_1_Pin|OUT_P_2_Pin|ENB_485_1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : OUT_P_0_Pin OUT_P_1_Pin OUT_P_2_Pin OUT_P_3_Pin
                           ENB_485_1_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_0 | OUT_P_0_Pin|OUT_P_1_Pin|OUT_P_2_Pin|OUT_P_3_Pin
                          |ENB_485_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
